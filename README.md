...
- Explicit workspace-file and selection attachments, size limits, credential-file exclusions, and a workspace-context permission switch. Responses propose code and diffs; they do not automatically edit or execute workspace files.
